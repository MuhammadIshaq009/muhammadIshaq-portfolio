...
import amazonConnect from '../app/assets/svg/skills/amazon-connect.svg';
import expressjs from '../app/assets/svg/skills/expressjs.svg';
import awsIamRoles from '../app/assets/svg/skills/aws-iam-roles.svg';
import awsS3 from '../app/assets/svg/skills/aws-s3.svg';
...
const databaseIconFallback = mysql;
...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'materialui':
      return materialui;
    case 'node js':
      return nodejs; // use custom node icon
    case 'express js':
      return expressjs;
    case 'nginx':
      return nginx;
    ...
    case 'fastapi':
      return fastapi;
    case 'tanstack table':
      return javascript; // fallback icon
    case 'pinecone db':
      return databaseIconFallback;
    default:
      break;
  }
}
